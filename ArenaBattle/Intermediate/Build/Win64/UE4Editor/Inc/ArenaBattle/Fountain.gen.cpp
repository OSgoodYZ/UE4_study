...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFountain()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_ID = { UE4CodeGen_Private::EPropertyClass::Int, "ID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020001, 1, nullptr, STRUCT_OFFSET(AFountain, ID), METADATA_PARAMS(NewProp_ID_MetaData, ARRAY_COUNT(NewProp_ID_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Water_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Fountain.h" },
				{ "ToolTip", "NOTE: VisibleAnywhere?? ?\xd6\xbe??????? ?????? \xc8\xaf?\xe6\xbf\xa1?? component?? ?????\xcf\xb4? ???? ??????????." },
			};
#endif
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Body_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Fountain.h" },
				{ "ToolTip", "NOTE: UPROPERTY?? UE4???? memory ?????? ?\xda\xb5????? ?\xc3\xb1??\xda\xb4\xd9\xb4? ?\xc7\xb9??\xcc\xb4?. ?? ?? UE4 object?? ???\xcf\xb4? ?\xcd\xb5\xe9\xb8\xb8 UPROPERTY?? ?????? ?????\xcf\xb4?." },
			};
#endif
	...
	IMPLEMENT_CLASS(AFountain, 2312598855);
